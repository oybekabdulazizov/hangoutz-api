...
public interface ExceptionMessage {
    ...
    String INVALID_DATETIME_FORMAT = "Invalid date format. Please use 'yyyy-MM-ddTHH:mm(:SS)' as 'T' is just a delimiter";
    String INVALID_DATE_FORMAT = "Invalid date format. Please use 'yyyy-MM-dd";
